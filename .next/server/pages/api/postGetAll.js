...
(() => {
var exports = {};
exports.id = "pages/api/postGetAll";
exports.ids = ["pages/api/postGetAll"];
exports.modules = {
...
/***/ "(api)/./src/pages/api/postGetAll.js":
/*!*************************************!*\
  !*** ./src/pages/api/postGetAll.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var _utils_connectMongoDB__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../utils/connectMongoDB */ \"(api)/./utils/connectMongoDB.js\");\n/* harmony import */ var _models_Post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../models/Post */ \"(api)/./models/Post.js\");\n\n\n/**\n * \n * @param {import('next').NextApiRequest} req \n * @param {import('next').NextApiResponse} res \n */ async function handler(req, res) {\n    if (req.method === \"GET\") {\n        try {\n            await (0,_utils_connectMongoDB__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n            const posts = await _models_Post__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find().exec();\n            res.json(posts);\n        } catch (error) {\n            res.status(500).json({\n                message: error\n            });\n        }\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./src/pages/api/postGetAll.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./src/pages/api/postGetAll.js"));
