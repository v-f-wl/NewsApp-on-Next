 ...
 */ async function handler(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            const posts = await _models_Post__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find({
                user: idPerson
            }).exec();
            res.json(posts);
        } catch (error) {
...
const connectDB = async ()=>mongoose__WEBPACK_IMPORTED_MODULE_0___default().connect(process.env.DB_KEY).then(()=>console.log("DB Okay")).catch(()=>console.log("Dont Connect"));
...
var __webpack_exports__ = (__webpack_exec__(4845));
