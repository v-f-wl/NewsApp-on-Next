...
(() => {
var exports = {};
exports.id = "pages/api/postRemove";
exports.ids = ["pages/api/postRemove"];
exports.modules = {
...
/***/ "(api)/./src/pages/api/postRemove.js":
/*!*************************************!*\
  !*** ./src/pages/api/postRemove.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var _utils_connectMongoDB__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../utils/connectMongoDB */ \"(api)/./utils/connectMongoDB.js\");\n/* harmony import */ var _models_Post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../models/Post */ \"(api)/./models/Post.js\");\n\n\n/**\n * \n * @param {import('next').NextApiRequest} req \n * @param {import('next').NextApiResponse} res \n */ async function handler(req, res) {\n    console.log(req.body);\n    if (req.method === \"DELETE\") {\n        try {\n            await (0,_utils_connectMongoDB__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n            const { id  } = req.query;\n            console.log(id);\n            _models_Post__WEBPACK_IMPORTED_MODULE_1__[\"default\"].findOneAndDelete({\n                _id: id\n            }).then((doc)=>{\n                if (!doc) {\n                    return res.status(404).json({\n                        message: \"Статья не найдена\"\n                    });\n                }\n                res.json({\n                    message: \"Succec\"\n                });\n            }).catch((err)=>{\n                res.status(404).json({\n                    message: \"Проблемы\"\n                });\n            });\n        } catch (error) {\n            console.log(error);\n            res.status(404).json({\n                message: \"Не удалось удалить пост\"\n            });\n        }\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./src/pages/api/postRemove.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./src/pages/api/postRemove.js"));
