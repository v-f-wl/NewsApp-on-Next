...
const AuthModal = () => {
  ...
  return ( 
    <div className="w-full h-full lg:w-2/3 lg:h-4/5 rounded-lg lg:grid lg:grid-cols-2 overflow-hidden">
      <div className="hidden lg:flex bg-orange-400  flex-col justify-center gap-4 px-20">
          <h2 className="text-white text-4xl font-bold">Welcome To Flumpf</h2>
